...
Component({
  ...
  methods: {
    // onGetUserProfile(e) {
    //   this.properties.onGetUserProfile(e)
    // },
    ...
    async onConfirmSendText(e) {
      this.try(async () => {
        ...
        console.log('friendid',this.properties.friendid)
        await db.collection('chatgroup').doc(this.properties.groupId).update({
          // data 传入需要局部更新的数据
          data: {
            [this.properties.friendid]:{
